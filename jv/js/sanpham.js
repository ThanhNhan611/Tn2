...
function themDemo() {
  ...
  let sp1 = new Product(
    ...
    "sp1.jpg",
    "SẢN PHẨM 1",
    "Nón Len Stussy Phong Cách Đơn Giản Thu Hút.",
    100000
  ...
  let sp2 = new Product(
    ...
    "sp2.jpg",
    "SẢN PHẨM 2",
    "Áo thun Stussy Basic Nam Nữ Phong Cách Casual.",
    150000
  ); // Tạo các đối tượng cho lớp Product
  let sp3 = new Product(
    3,
    "sp3.jpg",
    "SẢN PHẨM 3",
    "Áo Stussy Basic Phong Cách Street Wear 2024. ",
    120000
  ); // Tạo các đối tượng cho lớp Product
  let sp4 = new Product(
    4,
    "sp4.jpg",
    "SẢN PHẨM 4",
    "Áo thun nhuộm màu Stussy Surfwalk đơn giản. ",
    190000
  );
  let sp5 = new Product(
    5,
    "sp5.jpg",
    "SẢN PHẨM 5",
    "Áo thun Stussy Grassfed chính hãng trắng đen. ",
    100000
  ); // Tạo các đối tượng cho lớp Product
  let sp6 = new Product(
    6,
    "sp6.jpg",
    "SẢN PHẨM 6",
    "Áo thun Stussy chất liệu cotton 100% unisex. ",
    150000
  ); // Tạo các đối tượng cho lớp Product
  let sp7 = new Product(
    7,
    "sp7.jpg",
    "SẢN PHẨM 7",
    "Áo thun Stussy Beat Crazy chính hãng 100% màu đen. ",
    120000
  ); // Tạo các đối tượng cho lớp Product
  let sp8 = new Product(
    8,
    "sp8.jpg",
    "SẢN PHẨM 8",
    "Áo Thun Stussy Bản Mới, Áo Phông Vải Cotton 100%. ",
    190000
  );
  // Tạo các đối tượng cho lớp Product
